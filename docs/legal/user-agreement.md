...
This summary is not the agreement — it is here so you know what you are agreeing to. If the summary and the full text differ, the full text applies.

- RydrSafe collects safety reports from passengers about e-hailing drivers. **We are not the police, we are not a background-check service, and we are not connected to Uber, Bolt, inDrive, DiDi or any other operator.**
- A report is one person's account of what they say happened. **It is not proof.** A driver appearing on RydrSafe has not been found guilty of anything.
- **We do not publish a serious allegation on the strength of a single report.** Allegations of criminal conduct stay private, visible only to you and our moderators, unless they are independently corroborated (Part A, clause 6).
- We never publish what you wrote in the description box. Publicly, other users see a category, a severity band, a count and a date range — nothing that identifies you.
- Your screenshots are used to read text off them, then deleted. We do not keep an image library.
- **Submitting a report you know to be false can get you sued by the driver.** Defamation is a civil wrong in South Africa and we will hand over your identity if a court orders us to.
- Drivers can ask us what we hold about them, correct it, object to it, and appeal a decision. A human being — not the algorithm — makes every decision that changes a driver's status.
- **RydrSafe cannot make you safe.** Use your own judgement, and in an emergency call **10111**.
...
1.3 This agreement covers passengers and other registered users. Moderators and administrators are additionally bound by a separate internal undertaking.

1.4 If you appear on RydrSafe as a driver but have not registered an account, this agreement does not bind you. Your rights are set out in **Part C**, and they apply whether or not you ever use the service.

## 2. What RydrSafe is — and what it is not

2.1 RydrSafe is an independent community safety platform. Passengers upload screenshots from e-hailing apps; we read driver and vehicle details off those screenshots using optical character recognition (OCR); we check those details against reports other passengers have submitted; and we show the user a verification result.

2.2 **RydrSafe is not affiliated with, endorsed by, sponsored by, or connected to Uber, Bolt, inDrive, DiDi, or any other ride-hailing company.** Where we mention those names, we do so only to describe where a screenshot came from.

2.3 RydrSafe **is not**:

- a criminal record check, a background screening service, or a vetting service;
- a law-enforcement body, or a body charged by law with applying criminal law;
- a credit bureau or a registered credit reporting agency;
- an emergency service;
- a substitute for reporting a crime to the South African Police Service.

2.4 **Emergencies.** If you are in danger, call **10111** (SAPS), **112** from a mobile phone, or **10177** (ambulance). The GBV Command Centre is **0800 428 428**. RydrSafe does not monitor the service in real time and cannot dispatch help.

## 3. Eligibility and age

3.1 You must be **18 years or older** to create a RydrSafe account. This is not a formality: POPIA restricts the processing of children's personal information, and reports on this platform concern allegations of criminal conduct.

3.2 We may ask you to confirm or verify your age. If we establish that an account holder is under 18, we will close the account and delete the associated personal information, except where we are required to retain it.

3.3 You may not create an account on behalf of another person, or hold more than one account, without our written permission.

## 4. Your account

4.1 Keep your password confidential. You are responsible for activity under your account unless you tell us promptly that it has been compromised.

4.2 Give us accurate registration details, and keep them current. We need to be able to reach you if a report you submitted is challenged.
...
5.2 We match those details against our records using both exact and fuzzy matching, because OCR misreads characters. Fuzzy matching means **we sometimes match the wrong person.** A different driver with a similar name, or a registration number misread by one character, can produce a false match.

5.3 A verification result tells you what has been reported and corroborated on this platform. It does not tell you whether a driver is safe. **The absence of reports is not evidence of safety** — most drivers on the road have never been reported to us at all.

5.4 You must form your own judgement about whether to take a ride. Do not use a "clean" RydrSafe result as a reason to ignore your own instincts.

## 6. Reports — and when they become visible to others

This clause is the core safeguard of the platform. It exists because publishing an unproven allegation of criminal conduct about a named person is both a defamation risk and a restricted activity under POPIA.

### 6.1 Report categories

Reports fall into two groups:

**Category A — alleged criminal conduct.** Assault · Theft · Fraud · Intoxicated Driving · Harassment · Reckless Driving · and any report categorised as *Other* until a moderator reclassifies it.

**Category B — safety and conduct concerns.** Unsafe Vehicle · and any *Other* report a moderator has reclassified as not alleging an offence.

### 6.2 Publication stages

Every report moves through these stages. **No report is visible to other users when you submit it.**

| Stage | What it means | Who can see it | Effect on the driver's public status |
|---|---|---|---|
| **Pending** | Newly submitted. Awaiting moderation. | You and our moderators only. | None. |
| **Approved** | A moderator is satisfied the report is genuine, internally consistent, and not obviously malicious. | You and our moderators only. | None yet for Category A. Category B may show as a generalised concern. |
| **Corroborated** | The corroboration threshold in clause 6.3 is met. | Other users, in the limited form described in clause 6.4. | Contributes to the public risk indicator. |
| **Rejected / Withdrawn** | Not accepted, or withdrawn. | You and our moderators only. | None. Excluded from all scoring. |

### 6.3 The corroboration threshold
...
(c) the conduct is **already a matter of public record** in a form the data subject deliberately made public, or which was lawfully published by a court, tribunal or regulator.

A **Category B** report may be shown in generalised form on a single approved report.

**A single uncorroborated allegation of criminal conduct is never shown to other users.** It is retained, privately, so that a second independent report can corroborate it.

### 6.4 What other users actually see

Where a report is published, other users see only:

- the **category** and **severity band**;
- the **number** of corroborated reports;
...
Before a driver's public status changes to *Flagged* or *High Risk*, we will, where we have a usable contact detail for that driver and where doing so does not put a reporter at risk, notify the driver and give them a reasonable opportunity to respond. Their response is considered by a moderator before the status changes.

### 6.6 Our discretion

We may reject, edit for compliance, redact, or remove any report. We may decline to publish a report even where the threshold in clause 6.3 is met, if we judge publication unfair, unsafe, or unlawful. We are not obliged to publish anything.

## 7. Risk scores, and the right to a human decision

7.1 A risk score is generated from the number of corroborated reports, their severity, how recent they are, and their verification status. Bands are: Safe (0–29), Under Review (30–59), Flagged (60–79), High Risk (80–100).

7.2 **A risk score is not a criminal record, a conviction, a finding of fact, or a legal determination.** It is a summary of what this community has reported and what our moderators have accepted.

7.3 **Human review.** Under section 71 of POPIA, a person may not be subjected to a decision with legal consequences, or which affects them to a substantial degree, based solely on automated processing. Accordingly:

(a) the algorithm may compute a score, but **a moderator must approve any change to a driver's publicly visible status**;
(b) a driver may require that any status affecting them be reviewed by a person, and may make representations to that person (Part C, clause 35);
(c) we keep a record of who made each status decision and on what basis.

## 8. Your obligations when you report

By submitting a report you warrant that:

8.1 You **personally experienced or directly witnessed** the incident. Do not report something a friend told you, something you read online, or something you inferred.

8.2 Everything you state as fact is **true to the best of your knowledge**, and you have a genuine and reasonable belief in it.

8.3 You distinguish **what happened** from **what you concluded**. "The driver's speech was slurred and the car smelled of alcohol" is a fact you observed. "The driver was drunk" is a conclusion. Report the first.

8.4 You have **not altered, staged, or fabricated** any screenshot or evidence.

8.5 You are **not using RydrSafe to retaliate** over a fare dispute, a bad rating, a cancelled trip, a personal argument, or a rejected advance.

8.6 You are not reporting on the basis of the driver's race, nationality, ethnicity, home language, religion, gender, sexual orientation, disability, or immigration status. **Reports that are, in substance, complaints about who a driver is rather than what a driver did will be rejected and may result in a ban.** South Africa has a specific and serious problem with xenophobic targeting of foreign-national e-hailing drivers, and this platform will not be a vehicle for it.

8.7 You accept that we may ask you for further detail, and that we may reject your report if you do not respond.

## 9. Prohibited conduct

You may not:

- submit a report you know or suspect to be false, exaggerated, or misleading;
- submit the same incident multiple times, or coordinate with others to manufacture corroboration;
- create multiple accounts, or use another person's account, to influence a risk score;
- upload fabricated, edited, or AI-generated screenshots;
- upload content that is unlawful, hateful, obscene, or that incites violence;
- publish, or attempt to obtain from us, a driver's home address, identity number, banking details, or family details;
- contact, confront, threaten, or organise action against a driver on the basis of information obtained here;
- scrape, bulk-export, resell, or republish RydrSafe data, or use it to build a competing or derivative database;
- use the service to screen a person for employment, credit, insurance, or tenancy;
- interfere with, probe, or attempt to circumvent the security of the service.

**Vigilantism.** RydrSafe exists to help you avoid a ride. It does not exist to help you find, confront, or punish a driver. Using it for that purpose is a fundamental breach of this agreement and, depending on what you do, a crime.

## 10. Screenshots, copyright, and third-party trade marks

10.1 You may upload only screenshots of **your own trips**, taken from your own device, from an app you are lawfully using.
...
## 11. Licence you grant us

11.1 You keep ownership of what you submit.

11.2 You grant us a non-exclusive, royalty-free licence to store, process, moderate, redact, aggregate, anonymise and — subject strictly to clause 6 — publish your submission, for the purpose of operating RydrSafe. This licence lasts as long as we lawfully retain the content, and survives the closure of your account in respect of content already published or retained under clause 29.

11.3 We may use anonymised, aggregated statistics (for example, "reports by category by month") for research, reporting and public safety advocacy. Aggregated statistics never identify you or a driver.
...
- a statement that the information in the notice is true and correct to your knowledge.
...
13.1 We may suspend or close your account, with notice where practicable, if you breach this agreement, submit false or malicious reports, attempt to manipulate scores, abuse our moderators, or if we are legally required to.

13.2 Where we suspend an account, we will tell you why and give you a reasonable opportunity to respond, unless doing so would prejudice an investigation or put someone at risk.

13.3 You may close your account at any time from your profile. Closing your account does not automatically delete reports you have submitted — see Part B, clause 29.

## 14. Disclaimers

14.1 The service is provided **"as is" and "as available"**. We do not warrant that it will be uninterrupted, error-free, or that OCR extraction, matching, or scoring will be accurate.

14.2 We do not warrant the truth of any user-submitted report. Reports are the statements of the people who made them.

14.3 We do not vet, employ, endorse, or control any driver, and we have no relationship with any driver appearing on the platform.

14.4 Nothing in this agreement is legal advice.
...
(b) loss caused by our **gross negligence**, or by any intentional or reckless act or omission on our part (section 51(1)(c) of the Consumer Protection Act prohibits such an exclusion, and we do not attempt one);
(c) fraud or fraudulent misrepresentation;
(d) any liability that cannot lawfully be excluded under South African law, including your rights under the Consumer Protection Act and POPIA.

15.2 **What you accept.** Subject to 15.1, you accept that:

(a) verification results are based on **information submitted by other people**, and we are not liable for the accuracy, completeness or truthfulness of that information;
(b) OCR extraction and fuzzy matching are **inherently imperfect**, and may produce false matches or fail to match;
(c) **a clean result does not mean a driver is safe**, and you take responsibility for your own decision to take or refuse a ride;
(d) drivers act independently of us, and we are not liable for their conduct.

15.3 **Cap.** Subject to 15.1, our total aggregate liability to you arising out of or in connection with this agreement, in any 12-month period, is limited to the greater of **R1 000** or the total amount you paid us for the service in that period.

15.4 Subject to 15.1, we are not liable for indirect or consequential loss, loss of profit, loss of income, or loss of opportunity.

15.5 If a court finds any part of this clause unenforceable, the rest of it continues to apply.

## 16. Indemnity

16.1 You indemnify us against claims, losses and reasonable legal costs arising from content you submitted **in breach of clause 8 or 9** — in particular, a defamation claim brought by a driver in respect of a false or malicious report you made.

16.2 This indemnity does **not** apply to claims arising from our own conduct, our moderation decisions, our publication choices, our scoring, or any breach of this agreement by us.

16.3 We will tell you promptly of any claim to which this indemnity might apply, and will not settle it without consulting you.

## 17. Changes to this agreement

17.1 We may change this agreement. Where a change materially affects your rights, we will give you **at least 14 days' notice** by email and in the app, and you will be asked to accept the new version.
...
### 20.1 About you (a registered user)

| Category | Fields | Source |
|---|---|---|
| Account | Full name, email address, hashed password, role | You |
...
| Category | Fields | Source |
|---|---|---|
| Identifying | Driver name, phone number where visible | User-uploaded screenshots |
| Vehicle | Registration number, make, model, colour | User-uploaded screenshots |
| Reports | Category, severity, description, incident date, moderation status | Users and moderators |
| Derived | Risk score, status band, report counts | Computed by us |
| Driver correspondence | Objections, corrections, appeals, and our responses | The driver |

### 20.3 What we do not collect

We do not ask for or knowingly store identity numbers, home addresses, banking details, biometric data, health information, or precise location history. Do not put these in a report description. If you do, we will redact them.

## 21. Notice to drivers (POPIA s18)

21.1 Driver information does **not** come from drivers. It comes from passengers who uploaded screenshots of trips they took. POPIA section 18 requires that we take reasonably practicable steps to notify a person when we collect their information from someone else.
...
## 22. Why we process personal information

- To verify a driver against community reports at a user's request.
- To operate accounts, authentication and support.
- To moderate reports, detect duplicates, and identify coordinated or malicious reporting.
- To compute and maintain risk indicators, under human oversight.
- To handle driver objections, corrections and appeals.
- To keep the platform secure, and to keep audit logs.
- To comply with legal obligations and to respond to lawful requests.
- To produce anonymised, aggregated safety statistics.

We do not use personal information for any other purpose without telling you.

## 23. Lawful basis for each kind of processing

Section 11 of POPIA lists the grounds on which personal information may be processed. We set out ours honestly, per category. Note that *"public safety"* is not itself a ground in section 11 — where public safety motivates us, the ground we actually rely on is legitimate interest, and we say so.

| What we process | Ground | Notes |
|---|---|---|
...
This clause states our position squarely, because it is the most legally sensitive thing this platform does.

24.1 **The prohibition.** Section 26(b) of POPIA prohibits the processing of personal information concerning a person's criminal behaviour, to the extent it relates to the alleged commission of an offence, unless one of the authorisations in Chapter 3, Part B applies. Reports in **Category A** (Part A, clause 6.1) are exactly that: allegations of offences against identifiable people. A moderator's belief that a report "looks genuine" is not a lawful authorisation.

24.2 **What we rely on.** We rely on:

(a) **Section 27(1)(b)** — processing necessary for the establishment, exercise or defence of a right or obligation in law. Passengers have a constitutional right to freedom and security of the person, including the right to be free from all forms of violence (section 12 of the Constitution). A reporter recording an incident, and a passenger checking before entering a stranger's vehicle at night, are exercising and protecting that right. We limit ourselves to what is necessary for that purpose: corroborated categories and counts, not narratives, not identities.

(b) **Section 27(1)(e)**, in the narrow case where the information was deliberately made public by the data subject.
...
26.1 The risk score is produced by an algorithm using the number of corroborated reports, their severity, their recency and their verification status.

26.2 Under **section 71 of POPIA**, no driver's publicly visible status is set by the algorithm alone. A moderator reviews and approves every change to a driver's public status, and records the reasons.

26.3 A driver may ask for the score affecting them to be explained, may make representations about it, and may require human reconsideration (Part C, clause 35).

## 27. Sharing, operators, and cross-border transfers

27.1 **We do not sell personal information.** We do not share it for advertising.

27.2 We share it only:

- with our moderators and administrators, under confidentiality obligations, on a need-to-know basis;
- with our operators (below), who process it on our instructions only;
- with law enforcement or a court, where we are legally required to, or where there is a serious and imminent threat to a person's life or safety;
...
## 28. Security and breaches

28.1 We apply the safeguards required by section 19: HTTPS in transit, encryption at rest, passwords stored using a modern one-way hashing algorithm, JWT-based authentication with short-lived tokens and refresh-token rotation, role-based access control, least-privilege access for moderators, audit logging of every moderation action and every access to driver records, and regular review of those logs.

28.2 No system is perfectly secure. If there are reasonable grounds to believe personal information has been accessed or acquired by an unauthorised person, we will notify the **Information Regulator** and the affected people **as soon as reasonably possible** after discovery, as section 22 requires, and tell them what happened and what to do about it.
...
You may, at any time and free of charge unless the law allows a fee:

- **Ask what we hold about you** and be told who has had access to it (s23);
- **Correct or delete** information that is inaccurate, irrelevant, excessive, out of date, incomplete, misleading, or unlawfully obtained (s24);
- **Object** to processing based on legitimate interest, on reasonable grounds (s11(3)) — use **Form 1** of the POPIA Regulations;
- **Request correction or deletion** using **Form 2** of the POPIA Regulations;
- **Withdraw consent** where consent is the basis (this does not affect what was lawful before you withdrew);
...
We send marketing only if you opt in. Every message has an unsubscribe link. Service messages — security alerts, changes to this agreement, responses to your requests — are not marketing and you cannot opt out of them while you hold an account.
...
# PART C — DRIVER RIGHTS, FAIRNESS AND APPEALS

**This Part is addressed to drivers.** You do not need a RydrSafe account, and you do not need to accept anything, to exercise these rights. They exist because POPIA gives them to you.

## 33. What we hold, and where it came from

33.1 If passengers have uploaded screenshots of trips with you, we may hold your name, your phone number where it appeared, your vehicle registration, make and model, and any reports about you.
...
- **Access** everything we hold about you, in an intelligible form, and be told who has had access to it;
- **Correct** anything inaccurate, incomplete, misleading or out of date;
- **Delete** anything that is irrelevant, excessive, out of date, or unlawfully obtained;
- **Object** to our processing on reasonable grounds, using Form 1 of the POPIA Regulations;
- **Appeal** any moderation or scoring decision (clause 35);
- **Require a human decision** rather than an automated one (POPIA s71);
- **Complain to the Information Regulator**, or take us to court.

We do not charge for this. We respond within **30 days**.
...
35.4 **The disputed item is hidden from other users while we review it.** We would rather temporarily hide something true than leave something false in public.

35.5 If we uphold your appeal we remove or correct the information, recompute your score, and tell you what changed. If we dismiss it, we tell you why, in writing, and tell you how to escalate.

## 36. Mistaken identity

36.1 We match on names and registration numbers read by OCR, which makes errors, and different people share names and change vehicles.

36.2 If you believe a report belongs to someone else, tell us. We will immediately hide the disputed link and investigate. Where we cannot establish with reasonable confidence that a report concerns you, **we remove the link to you.** The burden is on the platform to justify the match, not on you to disprove it.

## 37. Reporters who abuse the platform

37.1 We monitor for coordinated, repeated and retaliatory reporting, and we ban accounts that do it.

37.2 If a court orders us to disclose the identity of a person who defamed you, we will comply with that order. We will not disclose a reporter's identity without a lawful basis, because doing so would expose people to retaliation.
